...
public class PRList extends JFrame {
	...
	private void initialize() {
		...
		frmPurchaseRequisition.setBounds(100, 100, 367, 358);
...
//		table = new JTable(DbUtils.resultSetToTableModel(PRID));
		String col[] = {"PR ID"};
		...
		scrollPane.setBounds(20, 82, 55, 172);
		...
		panel.setBounds(85, 100, 250, 154);
		...
		for(int i = 0; i < approved_pr.size(); i++) {
			...
			viewButtons.get(i).setIcon(new ImageIcon("C:\\Users\\Gabriel PC\\eclipse-workspace\\SEF\\viewbtn.png"));
